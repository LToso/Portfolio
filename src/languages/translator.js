...
const english = (id) => {
    switch (id) {
        ...
        case ('about1'): return <span>Hey! My name is <span className='highlight'>Leonardo</span> and I'm a <span className='highlight'>senior</span> developer living in Brazil. My love for coding dates back to 2008 when I started my <span className='highlight'>Systems Analysis and Development degree</span>. Since then I have been creating applications for several large companies here in <span className='highlight'>Brazil.</span></span>;
